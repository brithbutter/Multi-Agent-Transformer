...
from mat_src.mat.algorithms.utils.transformer_utils import init_,Encoder, Decoder


class MOMultiAgentTransformer(nn.Module):
    def __init__(self, state_dim, obs_dim, action_dim, n_agent,
        ...
        super(MOMultiAgentTransformer, self).__init__()
        ...
        self.encoder = Encoder(state_dim, obs_dim, n_block, n_embd, n_head, n_agent, encode_state,self.n_objective)
